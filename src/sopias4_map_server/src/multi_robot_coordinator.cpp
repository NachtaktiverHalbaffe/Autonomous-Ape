...
public:
    explicit MultiRobotCoordinator(const std::string & nodeName) : Node(nodeName){
            ...
            register_service = this -> create_service<sopias4_msgs::srv::Register>("register", std::bind(&MultiRobotCoordinator::register_callback, this, std::placeholders::_1, std::placeholders::_2));
            unregister_service = this -> create_service<sopias4_msgs::srv::Unregister>("unregister", std::bind(&MultiRobotCoordinator::unregister_callback, this, std::placeholders::_1, std::placeholders::_2));
